...
4. cathedral (Git remote)
   - URL: <https://github.com/Bekalah/cathedral>
   - Import method: git subtree add --prefix=external/cathedral cathedral main --squash
   - Notes: Full history squashed; contents staged under `external/cathedral` for review and selective merge.
