...
const isDevelopment = undefined.DEV || process.env.NODE_ENV === 'development';
const isProduction = undefined.PROD || process.env.NODE_ENV === 'production';
...
const ENV = {
    ...
    AZURE_SUBSCRIPTION_ID: undefined.VITE_AZURE_SUBSCRIPTION_ID || '',
    AZURE_RESOURCE_GROUP: undefined.VITE_AZURE_RESOURCE_GROUP || 'cathedral-research-rg',
    AZURE_TENANT_ID: undefined.VITE_AZURE_TENANT_ID || '',
    
    // Storage Configuration
    AZURE_STORAGE_ACCOUNT: undefined.VITE_AZURE_STORAGE_ACCOUNT || 'cathedralresearch',
    AZURE_STORAGE_CONTAINER: undefined.VITE_AZURE_STORAGE_CONTAINER || 'artifacts',
    
    // AI and Cognitive Services
    AZURE_OPENAI_ENDPOINT: undefined.VITE_AZURE_OPENAI_ENDPOINT || '',
    AZURE_OPENAI_KEY: undefined.VITE_AZURE_OPENAI_KEY || '',
    AZURE_OPENAI_DEPLOYMENT: undefined.VITE_AZURE_OPENAI_DEPLOYMENT || 'gpt-4',
    ...
    try {
      ...
      if (scene && typeof window !== 'undefined') {
        ...
        const {
          ...
          HolographicDisplay,
          AnimationUtils
        } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@cathedral/three-engine')); });
...
exports["default"] = SynthesisEngine;
