...
${Object.entries(elementCounts)
            ...
            .join(', '), ')}, #, #, Featured, Nodes, $, { nodes, : .slice(0, 5).map(node => `${node.id}. **${node.name}** (${node.element})
...
function showHelp() {
// console.log(`, Codex, 144, 99, Library, System, CLI, Usage, codex - library < command > [options], Commands, validate, Validate, all, Codex, datasets, search < query > Search, research, sources, node < id > Show, specific, Codex, node, details, nodes, List, all, Codex, nodes, elements, Show, nodes, by, element, chakras, Show, nodes, by, chakra, report, Generate, comprehensive, report, help, Show, this, help, Examples, codex - library, validate, codex - library, search, "sacred geometry", codex - library, node, 1, codex - library, elements, fire, codex - library, chakras, crown, For, more, information, visit, https, //github.com/Bekalah/cathedral
            `);
}
