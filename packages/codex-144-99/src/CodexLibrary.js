...
${this.libraryConnections.map(lib => `- **${lib.name}** (${lib.type}): ${lib.description}`).join(', ')}, #, #, Validation, Results
            -  ** Valid ** , $, { validation, : .isValid }
            -  ** Errors ** , $, { validation, : .errors.length }
            -  ** Warnings ** , $, { validation, : .warnings.length }
            -  ** Checksum ** , $, { validation, : .checksum }, #, #, Node, Distribution, by, Element, $, { this: .getElementDistribution() }, #, #, Recent, Activity
