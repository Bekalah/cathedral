...
exports.FacultyArtGenerator = void 0;
const azureAIFoundry_1 = require("./azureAIFoundry");
const facultyData = __importStar(require("../../data/complete-arcana-profiles.json"));
const researchData = __importStar(require("../../data/complete-rebecca-arcanae-influences.json"));
class FacultyArtGenerator {
    constructor(config) {
        this.config = config;
        this.aiFoundry = new azureAIFoundry_1.AzureAIFoundry(config);
    }
    /**
     * Generate art for a specific faculty member
     */
    async generateFacultyArt(request) {
    ...
    async generateAllFacultyArt(options) {
        ...
        for (let i = 0; i < facultyMembers.length; i += batchSize) {
            ...
            const batchPromises = batch.map(member => this.generateFacultyArt({
    ...
    getAllFacultyMembers() {
        const profiles = facultyData.arcana_faculty_profiles;
        return Object.values(profiles.major_arcana).map((faculty) => faculty.name);
    }
    buildInfluencesList(faculty, includeResearchContext = false) {
        const influences = [];
    ...
    getCodexNodeForFaculty(faculty) {
...
exports.FacultyArtGenerator = FacultyArtGenerator;
exports.default = FacultyArtGenerator;
//# sourceMappingURL=facultyArtGenerator.js.map