 ...
 */
export function generateVesicaPiscis(radius, center = { x: 0, y: 0 }) {
    const points = [];
    const circle1 = [];
    const circle2 = [];
 ...
 */
export function generatePentagram(radius, center = { x: 0, y: 0 }) {
    const points = [];
 ...
 */
export function generateOctagon(radius, center = { x: 0, y: 0 }) {
    const points = [];
 ...
 */
export function generateFibonacciSpiral(turns = 5, scale = 1, center = { x: 0, y: 0 }) {
    const points = [];
 ...
 */
export function generateFlowerOfLife(rings = 3, radius = 50, center = { x: 0, y: 0 }) {
    const circles = [];
    // Center circle
    const centerCircle = [];
    for (let i = 0; i < 360; i += 5) {
 ...
 */
export function generateMetatronsCube(size, center = { x: 0, y: 0 }) {
    const circles = [];
    const lines = [];
