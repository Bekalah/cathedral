 ...
 */
export function goldenRatio(value, useLarger = true) {
 ...
 */
export function applyGoldenLayout(containerSize, direction = 'horizontal') {
 ...
 */
export function goldenSpiralPoint(angle, radius, center = { x: 0, y: 0 }) {
 ...
 */
export function cathedralRatio(value, use144 = true) {
    return use144 ? value * SACRED_MATH.CATHEDRAL_RATIO : value * SACRED_MATH.CATHEDRAL_INVERSE;
}
//# sourceMappingURL=sacred-math.js.map